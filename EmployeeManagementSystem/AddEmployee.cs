...

{
    public partial class AddEmployee : UserControl
    {
        ...
        private void addEmployee_addBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    {
                        connect.Open();
                        string checkEmID = "SELECT COUNT(*) FROM tbl_employeeRecords WHERE employee_id = @emID AND delete_date IS NULL";
                        ...
                        using (SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string insertData = "INSERT INTO tbl_employeeRecords " +
                                ...
                                string path = Path.Combine(@"C:\Users\USER\Desktop\Rahman\EmployeeManagementSystem\EmployeeManagementSystem\Directory\"
        ...
        private void addEmployee_updateBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult check = MessageBox.Show("Are you want to UPDATE " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE tbl_employeeRecords SET full_name = @fullName" +
        ...
        private void addEmployee_deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult check = MessageBox.Show("Are you want to DELETE " +
                     "Employee ID: " + addEmployee_id.Text.Trim() + "?", "Confirmation Message",
                    MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateDate = "DELETE FROM tbl_employeeRecords WHERE employee_id = @employeeID";
                        ...
                        using (SqlCommand cmd = new SqlCommand(updateDate, connect))
                        {
                            ...
                            MessageBox.Show("Deleted successfully!"
                                , "Delete Date: " + today, MessageBoxButtons.OK, MessageBoxIcon.Information);
