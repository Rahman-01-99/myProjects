        ...
        public void displayTE()
        {
            if (connect.State != ConnectionState.Open)
            {
                try
                {
                    ...
                    string selectData = "SELECT COUNT(id) FROM tbl_employeeRecords WHERE delete_date IS NULL";
        ...
        public void displayAE()
        {
            if (connect.State != ConnectionState.Open)
            {
                try
                {
                    ...
                    string selectData = "SELECT COUNT(id) FROM tbl_employeeRecords WHERE status = @status " +
